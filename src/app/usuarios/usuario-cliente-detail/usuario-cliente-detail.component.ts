...
@Component({
    selector: 'app-usuario-cliente-detail',
    templateUrl: './usuario-cliente-detail.component.html',
    styleUrls: ['./usuario-cliente-detail.component.scss']
})
export class UsuarioClienteDetailComponent extends DetailAbstract implements OnInit {
