...
export class ImovelFormComponent implements OnInit {
    ...
    constructor(private formBuilder: FormBuilder,
        ...
        this.imovelForm = this.formBuilder.group({
            ...
            'valor_mensalidade_divida': [null, Validators.compose([ExtraValidators.conditional(
                group => group.controls.possui_divida.value,
                Validators.required
            )])],
    ...
    saveImovel() {
        ...
        if (!this.validateForm()) {
            this.imovelForm.controls['tipo'].setValue('imovel');
    ...
    validateForm(): boolean {
        return this.imovelForm.invalid && this.enderecoForm.invalid && this.condicaoComercialForm.invalid;
    }
}
